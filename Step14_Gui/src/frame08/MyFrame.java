...
public class MyFrame extends JFrame implements ActionListener{
	...
	public MyFrame() {
		...
		//JTextField 객체의 참조값을 필두에 저장(다른 메소드에서 사용가능하도록)
		inputMsg = new JTextField(14);
		add(inputMsg);
		JButton sendBtn = new JButton("전송");
		add(sendBtn);
		outputMsg = new JTextField(14);
		add(outputMsg);
	...
	public void actionPerformed(ActionEvent e) {
		...
		String msg1 = inputMsg.getText();
		//두번째 JTextField 객체에 출력하기
		outputMsg.setText(msg1);
